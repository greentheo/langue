...
def ensure_model_selected(config_manager: ConfigManager) -> None:
    ...
    if not ollama_models:
        console.print("[yellow]Warning: No Ollama models detected. Make sure Ollama is installed and running.[/yellow]")
        return
...
def show_progress(ctx):
    ...
    try:
        ...
        cursor.execute(
            ...
            """,
            (user.user_id, one_week_ago.isoformat())
        )
